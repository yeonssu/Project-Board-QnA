...
public class QuestionService {
    ...
    public QuestionDto.Response createQuestion(QuestionDto.Post questionPostDto) {
        Optional<Member> optionalMember = memberRepository.findByEmail(questionPostDto.getMemberEmail());
    ...
    public QuestionDto.Response getQuestion(Long questionId, LoginDto loginDto) {
        ...
        if (findQuestion.getPublicSecret().equals(Question.PublicSecret.SECRET)) {
